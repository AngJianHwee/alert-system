...
const App: React.FC = () => {
  ...
  <div className="max-w-full sm:max-w-xl mx-auto bg-white rounded-lg shadow p-4 sm:p-6 mb-8">
    <h2 className="text-lg sm:text-xl font-semibold mb-4">Create New Alert</h2>
    <div className="space-y-4">
      <div>
        <label className="block text-sm font-medium mb-1">Title</label>
        <input
  ...
  {/* Show all current alerts in JSON text */}
  <div className="text-xs sm:text-sm text-gray-600 mb-4">Current Alerts</div>
  <pre className="max-w-full mx-4 sm:mx-auto text-xs sm:text-sm overflow-x-auto">
